...
$sql_students = "SELECT prenom, nom FROM student WHERE classe = '6TTSEA'";
...
$sql = "SELECT name, matière, surname FROM user_form WHERE classe = '6TTSEA'";
...
<head>
    ...
    <style>
        ...
        td.droit { background-color: #B3E5FC; }
        td.scienceco { background-color: #C8E6C9; }
        ...
        td.langmod2 { background-color: #FFAB91; }
        td.educascien { background-color: #81C784; }
        ...
        td.tdcompta {background-color: #81C784;}
...
<body>
        ...
        <div>
                <h2 class="name-listl">Liste des élèves de 6TTSEA</h2>
                <ul class="student-list">
                    <?php foreach ($students as $student) { ?>
                        <li><?php echo $student["prenom"] . " " . $student["nom"]; ?></li>
                    <?php } ?>
                </ul>
            </div>
            ...
            <tr>
                ...
                <td rowspan="2" class="tdcompta">TD comptabilite<br><span class="local local-num">local 2</span></td>
                <td class="chimie">chimie<br><span class="local local-num">local 18</span></td>
                <td rowspan="2" class="droit">droit<br><span class="local local-num">local 3</span></td>
            ...
            <tr>
                ...
                <td class="scienceco">science economique<br><span class="local local-num">local 13</span></td>
                <td class="langmod2">langue moderne 2 <br><span class="local local-num">local 9</span></td>
            ...
            <tr>
                <td class="scienceco">sciences economique<br><span class="local local-num">local 12</span></td>
                <td class="same-course"></td>
                <td class="same-course"></td>
